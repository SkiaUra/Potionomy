...
//            float h = (EditorGUIUtility.singleLineHeight + _LinesOffsetY) * lines + (!_settings.sequencePropertyDrawerFoldout ? 0 : _ExtraBottomOpenMargin);
        ...
        /// <summary>
        /// Meant to be used only by <see cref="DOVisualSequencer"/> Inspector
        /// </summary>
        ...
        /// <summary>
        /// INTERNAL: only to be used by DOVisualSequencer Inspector
        /// </summary>
        static DOVisualSequence DoField(
            ...
            if (hasModifiedProperties) ValidateAllSequences(src, sequence, soSequence.serializedObject);
        ...
        /// <summary>
        /// Validates all sequences on the component and if it finds one with the same GUID as another resets it
        /// </summary>
