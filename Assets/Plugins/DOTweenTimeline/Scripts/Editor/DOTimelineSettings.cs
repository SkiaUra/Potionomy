...
#pragma warning restore 0649
        ...
        public const string ADBFilePath = "Assets/-DOTimelineSettings.asset";
        public const string DOTweenTimelineDirName = "DOTweenTimeline";
        public const string DOTweenTimelineFileListFile = "REQUIRED_DOTTFileList.txt";
        ...
        public static DOTimelineSettings Load()
        {
            ...
            if (I == null) I = DeEditorPanelUtils.ConnectToSourceAsset<DOTimelineSettings>(ADBFilePath, true, true);
            return I;
        }
