...
namespace DG.Tweening.TimelineEditor
{
    class DOVisualSequenceTimeline : EditorWindow, IHasCustomMenu
    {
        ...
        {
            menu.AddItem(new GUIContent("DOTween Timeline > Help"), false, ShowHelpPanel);
            menu.AddItem(new GUIContent("DOTween Timeline > Settings"), false, ShowSettingsPanel);
            ...
            menu.AddItem(new GUIContent("DOTween TImeline > Developer Debug Mode"), TimelineSession.isDevDebugMode, () => {
                TimelineSession.isDevDebugMode = !TimelineSession.isDevDebugMode;
            });
        }
...
//            Debug.Log(Time.frameCount + " ED > " + Event.current.type + ", undoPass: " + isUndoRedoPass + ", recOrPreviewUndoPass: " + isRecorderOrPreviewUndoPass);
        ...
        static void ConnectToSettings()
        {
            ...
            if (runtimeSettings == null) runtimeSettings = DeEditorPanelUtils.ConnectToSourceAsset<DOVisualSequenceSettings>(DOVisualSequenceSettings.EditorAdbPath, true, true);
        }
