...
namespace DG.Tweening.Timeline.Core.Plugins
{
    public class PlugDataGlobalTween : ITweenPluginData
    {
        ...
        public PlugDataGlobalTween(string label, DOGetter<float> getter, DOSetter<float> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<int> getter, DOSetter<int> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<uint> getter, DOSetter<uint> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<string> getter, DOSetter<string> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<Vector2> getter, DOSetter<Vector2> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<Vector3> getter, DOSetter<Vector3> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<Vector4> getter, DOSetter<Vector4> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<Quaternion> getter, DOSetter<Quaternion> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<Color> getter, DOSetter<Color> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
        ...
        public PlugDataGlobalTween(string label, DOGetter<Rect> getter, DOSetter<Rect> setter, PluginTweenType tweenType = PluginTweenType.SelfDetermined)
        {
